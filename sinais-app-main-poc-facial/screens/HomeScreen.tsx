      ...
      <ScrollView>
        ...
        >
          <View style={{ flexDirection: 'row', alignItems: 'center' }}>
            <MaterialCommunityIcons name="face-recognition" size={28} color="#0ea5e9" />
            <Text style={[styles.sectionTitle, { marginLeft: 8 }]}>Reconhecimento Facial (PoC)</Text>
          </View>
          <Text style={styles.sectionDescription}>
            Use a câmera para registrar presença ou autenticar-se via detecção de rosto (demonstração).
          </Text>
        </TouchableOpacity>
